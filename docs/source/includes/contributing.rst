...
.. toctree::
   ...
   contributing/general/reporting_issues.rst
   contributing/general/pr_workflow.rst
   contributing/general/reviewing.rst
   contributing/general/releasing.rst

.. toctree::
   :caption: Contributing to the backend
   :maxdepth: 1

   contributing/backend/style_design.rst
